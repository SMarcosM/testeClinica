...
public class usuarios {
    ...
    public void configuraraConexao(Connection conBanco) {
    ...
    public boolean inserirRegistro(c_usuarios usuario) {
        ...
        try {
            strComandoSQL = "INSERT INTO usuarios(Identificacao_Usuario,Senha_Acesso,Cadastro_Funcionario, "
                    + "Cadastro_Usuario,Cadastro_Paciente," + "Cadastro_Especialidade,"
                    + "Cadastro_Medico,Cadastro_Convenio,Agendamento_Consulta,"
                    + "Cancelamento_Consulta,Modulo_Administrativo,Modulo_Agendamento,Modulo_Atendimento)"
