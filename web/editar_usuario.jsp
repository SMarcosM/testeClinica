<%-- 
    ...
    Created on : 28/11/2020, 08:58:01
    Author     : SEBASTIÃO
--%>
...
<html> <head>
    ...
    <body class="FundoPagina">
       ...
       <% if (blnConectado) {%> <p class="TituloAplicacao">SGC - Sistema de Gestão de Clínicas 1.0</p> 
...
<p><input name="chkAdministrativo" type="checkbox" value="Administrativo" checked="checked" />Módulo administrativo</p>
<% }
else
{ %>
<p><input name="chkAdministrativo" type="checkbox" value="Administrativo" />Módulo administrativo</p>
<% } %>
...
<p class="RodapePagina">Copyright(c) 2020 - SebastiaoMM.</p>
<%}%>
   </body>
</html>
